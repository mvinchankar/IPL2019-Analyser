...
public class SortingContainer {
    ...
    public Comparator getParameter(FieldsToSort parameter) {
        ...
        Comparator<IPLDAO> battingStrikeRateComparator = Comparator.comparing(census -> census.strikeRate);
        Comparator<IPLDAO> bowlingAverageComparator = Comparator.comparing(census -> census.averageOfBatsmen);
        Comparator<IPLDAO> bowlingStrikeRateComparator = Comparator.comparing(census -> census.strikeRatesOfBowler);
        ...
        Comparator<IPLDAO> bowlingEconomyRateComparator = Comparator.comparing(census -> census.economyOfBowler);
        ...
        iplHashMap.put(FieldsToSort.BY_4s_AND_6s, new SortMethodContainer().reversed());
        iplHashMap.put(FieldsToSort.BY_STRIKERATE_WITHMOST_4sAND6s, new SortMethodContainer()
        ...
        iplHashMap.put(FieldsToSort.BY_AVERAGE_WITH_MOST_RUNS, comparator1.thenComparing(compare1 ->
        ...
        iplHashMap.put(FieldsToSort.BY_TOP_BOWLING_STRIKING_RATES_WITH_MOST_4Ws_AND_5Ws, new
        ...
        iplHashMap.put(FieldsToSort.BY_MOST_BATTING_RUNS_WITH_MOST_BOWLING_WICKETS,
                new MostRunsAndMostWicketsComparator());
